...
Math.floor para colocar os numeros  interios(ele retorna um numero inteiro 
)*/
function fraseDaSorte(){
  const mixFrase =Math.floor(Math.random() * frases.length);
  document.querySelector("#message").innerHTML= frases[mixFrase]
}
